        ...
        @foreach ($habitaciones as $habitacion)
            <div {{-- Colores --}}
                ...
                {{ $habitacion->estado === 'Disponible'
                    ? 'bg-green-800 border-green-800 dark:bg-green-700 dark:border-green-900'
                    : ($habitacion->estado === 'Ocupada'
                        ? 'bg-gray-700 border-gray-700 dark:bg-gray-700 dark:border-gray-300'
                        : ($habitacion->estado === 'Limpiar'
                            ? 'bg-red-700 border-yellow-600 dark:bg-orange-800 dark:border-yellow-700'
                            : ($habitacion->estado === 'Mantenimiento'
                                ? 'bg-blue-800 border-blue-800 dark:bg-blue-700 dark:border-blue-900'
                                : ($habitacion->estado === 'Deshabilitada'
                                    ? 'bg-[#0c0e27] border-gray-900 dark:bg-[#0c0e27] dark:border-white'
                ...
                <div class="flex items-center justify-between gap-2">
                    ...
                    @switch($habitacion->estado)
                        @case('Ocupada')
                            <!-- Icono de Ocupado -->
                            <svg class="ml-2 text-white w-11 h-11 dark:text-white" xmlns="http://www.w3.org/2000/svg"
                ...
                <!-- Título -->
                <a href="#">
                    <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-100 dark:text-gray-100">Need a help
                        in
                        Claim?</h5>
                </a>

                <!-- Descripción -->
                <p class="mb-3 font-normal text-gray-300 dark:text-gray-300">
                    Descripción corta de habitación:
                </p>
